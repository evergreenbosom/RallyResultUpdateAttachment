...
public class RallyTestCasesUpdateWithAttachment {
...
//    			String testEnv = "Dev - Iteration 3";
    ...
    public static JsonObject getCurrentIterationRef(String workspaceRef, String projectRef) {
        ...
        currentIterationRequest.setQueryFilter(new QueryFilter
                ("StartDate", "<=", date).and(new QueryFilter("EndDate", ">=", date)));
